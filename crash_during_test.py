...
def message_content(crash_name, crash_message, first_build,
                    last_build, channels):
    return "\n"\
        "*Crash in Hudl Test: {}*\n"\
        "{}\n"\
        ...
        "last caused by user {}".format(crash_name, crash_message, first_build, channels[0], last_build, channels[1])
...
def notify(crash_name, crash_message, first_build, last_build,
    ...
    payload = json.dumps({
        ...
        "Test Crashes",
        "text":
        message_content(crash_name, crash_message, first_build,
                        last_build, channels),
        "icon_emoji":
        ":ghost:"
    })
...
def main():
    try:
        ...
        while number_of_crashes > 0:
            ...
            crash_message = get_user(number_of_crashes)
            ...
            if "Fatal Exception: RIP" in crash_message:
                ...
                notify(crash_name, crash_message, first_build,
